...
{
    public class QuestionAnswer : IAnswerable
    {
        private static int _answersCounter;
        ...
        public QuestionAnswer(string[] answers, string correctAnswer)
        {
            _answers = answers;
            _correctAnswer = correctAnswer;
            ++_answersCounter;
            _questionNumber = _answersCounter;
        }
